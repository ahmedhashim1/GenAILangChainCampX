...
class Review(TypedDict):
    key_themes: Annotated[list[str], 'Write down all the key features discuss in the review in list']
    summary: Annotated[str, "A brief summary of the review."]
    sentiment: Annotated[
        Literal['pos', 'neg', 'avg'], 'Return sentiment for the review, either positive, negative, or neutral']
    score: Annotated[float, 'Return score for the review between 1-5 (1 is worse and 5 is the best)']
    pros: Annotated[Optional[list[str]], 'Write down pros from the review in list']
    cons: Annotated[Optional[list[str]], 'Write down cons from the review in list']
    review_name: Annotated[Optional[str], 'Write down name of the reviewer if available']
